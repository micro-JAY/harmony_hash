...
export const translations: Record<Locale, Record<string, string>> = {
  ...
  ja: {
    ...
    "Type a chord and press Enter to add it. Select a chord to reveal its remove action, drag it inside to reorder, or drag it onto the removal target. Press Delete to remove a focused chord, or Alt plus an arrow key to move it.": "コードを入力してEnterで追加します。コードを選ぶと削除ボタンが表示されます。内側へドラッグすると並べ替え、削除エリアへドラッグすると削除できます。選択中のコードはDeleteで削除、Alt＋矢印キーで移動できます。",
    "Drop here to remove selected chord": "ここにドロップして選択中のコードを削除",
