...
- **[Risk] A pin falls outside the viewport after resize.** → Constrain every subsequent drag to the live viewport layer and clamp the initial placement; responsive tests cover common sizes.
