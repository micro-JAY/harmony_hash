...
- [x] 1.1 Add the localized policy footer control and accessible modal.
...
- [x] 3.1 Run format, type, unit, and production-build checks.
- [x] 3.2 Run desktop and mobile browser verification.
