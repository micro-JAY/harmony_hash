...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "Every chord is a doorway to another.": "Every chord is a doorway to another.",
    "Follow the tension. Find the release.": "Follow the tension. Find the release.",
    "Build progressions by ear, shape, and feel.": "Build progressions by ear, shape, and feel.",
    "Try a chord. Hear what comes next.": "Try a chord. Hear what comes next.",
    "Harmony is a map, not a maze.": "Harmony is a map, not a maze.",
  ...
  ja: {
    ...
    "Every chord is a doorway to another.": "どのコードも、次の響きへの入り口になる。",
    "Follow the tension. Find the release.": "緊張をたどって、解放を見つけよう。",
    "Build progressions by ear, shape, and feel.": "耳と形と感覚で、コード進行を組み立てよう。",
    "Try a chord. Hear what comes next.": "コードを鳴らして、次の響きを聴いてみよう。",
    "Harmony is a map, not a maze.": "ハーモニーは迷路じゃない。音の地図だ。",
    ...
    "Pin chord preview": "コードプレビューを固定",
    "Move pinned chord card": "固定したコードカードを移動",
    "Dismiss pinned chord card": "固定したコードカードを閉じる",
    Suggest: "候補",
    "Hide grid ↑": "グリッドを閉じる ↑",
