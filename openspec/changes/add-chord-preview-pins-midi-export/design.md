...
- **[Risk] JavaScript placement geometry drifts from CSS after a token or root-font change.** → Resolve the semantic width and conservative placement-height tokens to pixels at runtime, observe root sizing/style changes, and pass those measured dimensions into the pure placement algorithm.
