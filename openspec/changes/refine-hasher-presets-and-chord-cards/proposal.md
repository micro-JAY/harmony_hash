...
- Complete the dedicated IMPROV INSIGHT presentation across HASHER and TUNE TOOLBOX: pale pink launch/actions and all four metadata boxes, a complete four-category vocabulary dialog, display-face scale names, shared named-degree colors for scale names and notes across IMPROV INSIGHT, SCALE SYNTHESIA, and FRET FINDER, bounded centered width, compact notes, and a short aligned match meter.
