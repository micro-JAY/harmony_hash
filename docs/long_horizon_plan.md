...
**Shared theory engine.** Items 2.2, 2.3, 2.5, 2.7, 2.9, and 2.11 all consume one library under `src/lib/theory/`. Pure functions, exhaustive unit tests, no duplicated scoring logic per view. This is non-negotiable per `§4 Shared-engine principle`.
