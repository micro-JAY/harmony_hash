...
- [x] 8.5 Require exact-head GitHub build/test, both complete Playwright jobs, and Cloudflare Workers build to pass before handoff; keep PR #75 draft until the user approves all remaining issues.
