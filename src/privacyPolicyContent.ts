  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "We use HTTPS, short-lived voice-session credentials, server-side provider keys, rate limiting, access controls, data minimization, and provider security services. No system is completely secure. We investigate and mitigate qualifying incidents and notify people and authorities where law requires.",
      },
      {
        title: "16. Children",
