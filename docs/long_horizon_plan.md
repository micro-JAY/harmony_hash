...
| 2.8.x.a | **Fretboard tuning + handedness expansion.** Standard/Drop D/Open G and common bass tunings plus left-handed presentation reversal. | — | `fretboard-tunings-handedness` | extends `guitar-fretboard` | Explicit follow-up; no inert controls in 2.8 v1. |
