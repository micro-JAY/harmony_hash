...
| 2.3 | **Improv Insight** — progression-aware scale suggestions with motion/tension/palette/style metadata. Per-chord and whole-progression tabs. Builds on `src/lib/theory/`. | `feat/improv-insight` | `improv-insight` | new capability `improv-insight`; consumes `src/lib/theory/` | Pending. Shared engine with 2.5. |
